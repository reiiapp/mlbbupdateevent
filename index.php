            ...
            <div class="conatineralexmoba" id="AlexHosting">
                ...
                <div class="banneralexmoba">
                    <div class="slideralexbanner">
                        <iframe width="378" height="182" src="https://www.youtube.com/embed/kxPPzguYsZc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            ...
                            <div class="contalexitem contalexclaim">
                                <div class="itemalexmoba">
                                    <div class="imgitemalexmoba">
                                        <img src="https://i.ibb.co/zrRfSNL/1646536375258.jpg">
                                    </div>
                                    <button onclick="showAlexlogin()" onmousedown="buka.play();">Claim</button>
                                </div>
                                <div class="itemalexmoba">
                                    <div class="imgitemalexmoba">
                                        <img src="https://i.ibb.co/nw8FbbQ/1646536244231.jpg">
                                    </div>
                                    <button onclick="showAlexlogin()" onmousedown="buka.play();">Claim</button>
                                </div>
                                <div class="itemalexmoba">
                                    <div class="imgitemalexmoba">
                                        <img src="https://i.ibb.co/g44kC25/1646536311842.jpg">
                                    </div>
                                    <button onclick="showAlexlogin()" onmousedown="buka.play();">Claim</button>
                                </div>
                                <div class="itemalexmoba">
                                    <div class="imgitemalexmoba">
                                        <img src="https://i.ibb.co/ftbLPW1/1646536147701.jpg">
                                    </div>
                                    <button onclick="showAlexlogin()" onmousedown="buka.play();">Claim</button>
                                </div>
                                <div class="itemalexmoba">
